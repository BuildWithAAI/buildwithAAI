# AAI-P-0008: Creator-fee account and community-benefit policy
...
| Related brief | [Detailed brief](../../docs/FUNDING.md) |
| First task | [AAI-T-028](../../tasks/BACKLOG.md#aai-t-028) |
| Token impact | Proposal only; no supply, authority, fee, wallet, migration, or token-launch change implemented |

## Problem and proposed result

The founder wants creator revenue to support technology and potentially return resources to contributors and the community.

Document allocation to a dedicated trading account and possible uses of any profits, with controls and auditable records.

## Requirements and risks

Capital loss, account control, fee eligibility, accounting, disclosure, distribution terms, and applicable review remain unresolved.
...
A concrete policy and ledger design without funding an account, promising a payout, or conducting token purchases.
