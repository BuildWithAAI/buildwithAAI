# AAI-P-0007: Personal trading assistant
...
| First task | [AAI-T-026](../../tasks/BACKLOG.md#aai-t-026) |
| Token impact | Proposal only; no supply, authority, fee, wallet, migration, or token-launch change implemented |

## Problem and proposed result

People need sourced market context without attention overload.

Define user-named Pump.fun/trenching and spot/leverage modes, beginning with a bounded research report workflow.

## Requirements and risks

Providers, freshness, privacy, costs, text/voice feasibility, and separate action permissions need review.
...
A reviewable specification and example reports with stale, missing, and conflicting evidence; no account execution.
