...
Issue comments are sufficient for discussion initially. Issues were enabled and Discussions was disabled at the September 22, 2026 verification. If the owner later enables Discussions, create an Ideas category with slug `ideas` before using the supplied category form. This documentation update does not change that setting. [GitHub category-form documentation](https://docs.github.com/en/discussions/managing-discussions-for-your-community/creating-discussion-category-forms).
